...
const fullText1 = ["Hii, chào Ly ^^"];
const fullText2 = ["Bn đang làm gì đó?"];
const fullText3 = ["Bn thấy dthw hog nè^"];
const fullText4 = ["Bn ổn hong?"];
const fullText5 = ["Nếu hong ổn thì..."];
const fullText6 = ["Đã có tui đây rồi nè^^"];
const allTexts = [fullText1, fullText2, fullText3, fullText4, fullText5, fullText6];
